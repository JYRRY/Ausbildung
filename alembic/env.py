"""Alembic environment — async-aware, sources URL + metadata from jyry.*"""
...
# URL is passed directly in run_migrations_online/offline to avoid
# configparser interpreting % as interpolation syntax.
